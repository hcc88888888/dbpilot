...
func TestAssertHostPluginDatabaseRequiresCompleteScopedDurableEvidence(t *testing.T) {
	...
	state := hostPluginState{EnrollmentRevision: 1, VersionID: "version-1", PluginVersion: "1.0.0", AssignmentID: "assignment-1", AssignmentPID: 42, InstanceIDs: []string{"mysql-1", "mysql-2"}, TemplateID: "template-1", TemplateRevisionID: "revision-1"}
