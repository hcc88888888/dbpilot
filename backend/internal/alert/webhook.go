...
func publicWebhookIP(address net.IP) bool {
	...
	if ipv4 := address.To4(); ipv4 != nil {
		address = ipv4
	} else if !webhookIPv6GlobalUnicastNetwork.Contains(address) {
		return false
	}
...
var _, webhookIPv6GlobalUnicastNetwork, _ = net.ParseCIDR("2000::/3")
...
var webhookSpecialUseNetworks = func() []*net.IPNet {
	ranges := []string{
		...
		"::/128", "::1/128", "64:ff9b::/96", "64:ff9b:1::/48", "100::/64", "100:0:0:1::/64", "2001::/23", "2001:db8::/32", "2002::/16", "3fff::/20", "5f00::/16", "fc00::/7", "fec0::/10", "fe80::/10", "ff00::/8",
	}
