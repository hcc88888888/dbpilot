...
func problemForError(err error, requestID, instance string) openapi.Problem {
	...
	switch {
	case errors.Is(err, ErrInvalidRequest), errors.Is(err, artifact.ErrInvalid), errors.Is(err, audit.ErrInvalidEvent), errors.Is(err, audit.ErrInvalidCursor), errors.Is(err, platformscope.ErrInvalid):
