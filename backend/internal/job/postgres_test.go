...
func TestClaimOutboxLeasesRowsWithSkipLockedInCreationOrder(t *testing.T) {
	...
	rows := sqlmock.NewRows(columns).
		AddRow("msg-1", "tenant-1", "project-1", "job-1", "db-1", "agent.command", mustUnsignedCollectPayload("db-1"), nil, createdOne, createdOne, at.Add(DefaultOutboxLease), nil, 1, "pending", nil, nil, nil, nil, nil, "", nil, nil, 0, "pending", nil, nil, nil, nil, 0, 0, nil, nil, nil, nil, nil, nil, nil, false, "", "", "", []byte("{}"), nil, 0, nil, "", "", "", []byte("[]"), false).
		AddRow("msg-2", "tenant-1", "project-1", "job-1", "db-2", "agent.command", mustUnsignedCollectPayload("db-2"), nil, createdTwo, createdTwo, at.Add(DefaultOutboxLease), nil, 1, "pending", nil, nil, nil, nil, nil, "", nil, nil, 0, "pending", nil, nil, nil, nil, 0, 0, nil, nil, nil, nil, nil, nil, nil, false, "", "", "", []byte("{}"), nil, 0, nil, "", "", "", []byte("[]"), false)
