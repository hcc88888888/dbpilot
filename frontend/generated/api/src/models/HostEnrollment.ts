 ...
 */
export function instanceOfHostEnrollment(value: object): value is HostEnrollment {
...
export function HostEnrollmentFromJSON(json: any): HostEnrollment {
    return HostEnrollmentFromJSONTyped(json, false);
}

export function HostEnrollmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): HostEnrollment {
    if (json == null) {
        return json;
    }
    return {
...
export function HostEnrollmentToJSON(json: any): HostEnrollment {
    return HostEnrollmentToJSONTyped(json, false);
}

export function HostEnrollmentToJSONTyped(value?: HostEnrollment | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
